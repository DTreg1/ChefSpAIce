 ...
 */
export type UpdateAuthProviderInfo = Partial<
  Omit<AuthProviderInfo, "id" | "userId">
>;
...
export const authProviders = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("auth_providers_provider_id_idx").on(
      table.provider,
      table.providerId,
    ),
  ],
...
export const insertAuthProviderSchema = createInsertSchema(
  authProviders,
).extend({
...
export const insertUserSchema = createInsertSchema(users).extend({
  ...
  notificationTime: z
    ...
    .default("09:00"),
  primaryProvider: z
    .enum(["google", "github", "twitter", "apple", "email", "replit"])
    .optional(),
});
