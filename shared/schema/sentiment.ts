...
export const alertTypeSchema = z.enum(["sentiment_drop", "sustained_negative", "volume_spike", "category_issue"]);
export const sentimentSeveritySchema = z.enum(["low", "medium", "high", "critical"]);
export const sentimentAlertStatusSchema = z.enum(["active", "acknowledged", "resolved"]);
