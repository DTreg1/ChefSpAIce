...
export const fieldTypeSchema = z.enum(['string', 'number', 'date', 'boolean', 'array', 'object']);
export const outputFormatSchema = z.enum(['json', 'table', 'csv']);
export const validationStatusSchema = z.enum(['pending', 'validated', 'corrected', 'rejected']);
