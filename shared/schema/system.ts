 ...
 */
export const maintenancePredictions = pgTable(
...
export const apiNameSchema = z.enum([
  "openai",
  "stripe",
  "usda",
  "barcode",
...
export const insertApiUsageLogSchema = createInsertSchema(apiUsageLogs).extend({
...
export const insertActivityLogSchema = createInsertSchema(activityLogs).extend({
...
export const insertSystemMetricSchema = createInsertSchema(
  systemMetrics,
).extend({
...
export const insertMaintenanceHistorySchema = createInsertSchema(
  maintenanceHistory,
).extend({
...
export type InsertMaintenanceHistory = z.infer<
  typeof insertMaintenanceHistorySchema
>;
