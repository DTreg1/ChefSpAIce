 ...
 */
export const altTextQuality = pgTable(
  "alt_text_quality",
  {
    id: varchar("id")
      .primaryKey()
 ...
 */
export const imageProcessing = pgTable(
  "image_processing",
  {
    id: varchar("id")
      .primaryKey()
    ...
    userId: varchar("user_id")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
    imageId: varchar("image_id").references(() => imageMetadata.id, {
      onDelete: "cascade",
    }),
...
export const ocrCorrections = pgTable(
  ...
  {
    id: serial("id").primaryKey(),
    ocrResultId: varchar("ocr_result_id")
      .notNull()
...
export const faceDetections = pgTable(
  "face_detections",
  {
    ...
    faceCoordinates: jsonb("face_coordinates")
      .$type<
        Array<{
          x: number;
          y: number;
...
export const imageProcessingJobOperationSchema = z.enum([
  "resize",
  "compress",
  "thumbnail",
  "watermark",
...
export const insertImageProcessingJobSchema = createInsertSchema(
  imageProcessingJobs,
)
...
export type InsertImageProcessingJob = z.infer<
  typeof insertImageProcessingJobSchema
>;
export type ImageProcessingJob = typeof imageProcessingJobs.$inferSelect;

// Image Presets
export const insertImagePresetSchema = createInsertSchema(imagePresets).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertOcrResultSchema = createInsertSchema(ocrResults).extend({
