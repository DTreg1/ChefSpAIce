export default function AttributionsPage() {
  return (
    <div className="min-h-screen bg-[#0F1419]" data-testid="page-attributions">
      ...
      <main className="container mx-auto py-8 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold mb-6 text-white" data-testid="text-page-title">Attributions</h1>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-6">
              ...
              <div className="border border-white/10 rounded-lg p-6 bg-[#1A1F25]" data-testid="card-attribution-expo">
                <div className="flex items-center mb-4">
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" className="text-white mr-3">
                    <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                  </svg>
                  <h3 className="text-xl font-semibold text-white">Expo & React Native</h3>
                </div>
                <p className="text-gray-400 mb-3">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-semibold mb-6 text-white">Open Source Libraries</h2>
            
            <div className="border border-white/10 rounded-lg p-6 bg-[#1A1F25]" data-testid="card-attribution-opensource">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-semibold mb-4 text-white">Licensing</h2>
            <div className="border border-white/10 rounded-lg p-6 bg-[#1A1F25]">
              <ul className="space-y-3 text-gray-400">
                <li>
                  <span className="text-white font-medium">OpenAI:</span> Used under{" "}
                ...
                <li>
                  <span className="text-white font-medium">Open Food Facts:</span> Data under{" "}
                ...
                <li>
                  <span className="text-white font-medium">USDA FoodData Central:</span> Public domain resource provided by the U.S. Department of Agriculture
                </li>
                <li>
                  <span className="text-white font-medium">Replit:</span> Used under{" "}
