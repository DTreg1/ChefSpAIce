...
export default function AboutPage() {
  ...
  return (
    <div className={`min-h-screen ${bgMain}`} data-testid="page-about">
      <WebHeader />

      <main className="container mx-auto py-8 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className={`text-3xl font-bold mb-6 ${textPrimary}`} data-testid="text-page-title">About ChefSpAIce</h1>
          
          <section className="mb-10">
            <h2 className={`text-2xl font-semibold mb-4 ${textPrimary}`}>Our Mission</h2>
          ...
          <section className="mb-10">
            <h2 className={`text-2xl font-semibold mb-4 ${textPrimary}`}>Technology Stack</h2>
            <p className={`${textSecondary} mb-4`}>
              ChefSpAIce is built using modern mobile and web technologies to provide a seamless experience across all platforms:
            </p>
            <ul className={`list-disc pl-6 mb-6 space-y-2 ${textSecondary}`}>
              <li><span className={`font-medium ${textPrimary}`}>Mobile App:</span> React Native with Expo for iOS and Android</li>
              <li><span className={`font-medium ${textPrimary}`}>Backend:</span> Node.js with Express</li>
              <li><span className={`font-medium ${textPrimary}`}>Database:</span> PostgreSQL for reliable data storage</li>
              <li><span className={`font-medium ${textPrimary}`}>AI:</span> OpenAI GPT-4o-mini for recipe generation and kitchen assistance</li>
              <li><span className={`font-medium ${textPrimary}`}>Hosting:</span> Deployed on Replit for seamless cloud operation</li>
            </ul>
          </section>

          <section className="mb-10">
            <h2 className={`text-2xl font-semibold mb-4 ${textPrimary}`}>Partners and Attributions</h2>
            ...
            <div className="space-y-6">
              <div className={`border rounded-lg p-6 ${bgCard}`} data-testid="card-attribution-openai">
                ...
                <ul className={`list-disc pl-6 ${textSecondary}`}>
          ...
          <section className="mb-10">
            <h2 className={`text-2xl font-semibold mb-4 ${textPrimary}`}>Legal Information</h2>
            <p className={`${textSecondary} mb-4`}>
