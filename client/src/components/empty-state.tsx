...
export function EmptyState({ type, onAction }: EmptyStateProps) {
  if (type === "chat") {
    return (
      <div className="flex items-center justify-center h-full p-8 animate-fade-in" data-testid="empty-state-chat">
        <div className="glass-subtle backdrop-blur-md rounded-2xl shadow-glass p-8 max-w-2xl w-full">
