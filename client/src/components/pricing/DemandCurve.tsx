          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <Badge variant="secondary">
                Optimal: ${optimalPrice.price}
              </Badge>
              <Badge variant={parseFloat(optimalPrice.price) > basePrice ? "default" : "destructive"}>
                {parseFloat(optimalPrice.price) > basePrice ? "↑" : "↓"} 
                {Math.abs(parseFloat(optimalPrice.price) - basePrice).toFixed(2)}
              </Badge>
              <Badge variant="outline">
                  ...
                  content={({ active, payload }) => {
                    ...
                    return (
                      <div className="bg-background border rounded-lg p-2 shadow-lg">
                        ...
                        <p className="text-sm text-gray-600">Margin: {data.profit}%</p>
                      </div>
                    );
                  }}
                />
                  ...
                  content={({ active, payload }) => {
                    ...
                    return (
                      <div className="bg-background border rounded-lg p-2 shadow-lg">
                        ...
                        <p className="text-sm text-blue-600">Demand: {data.demand}%</p>
                        <p className="text-sm text-yellow-600">Inventory: {data.inventory}%</p>
                        {data.reason && (
