...
export interface LoaderProps {
  ...
  // Note: Text is always displayed below the animation
...
export function CookLoader({
  ...
  // Always display text below animation
  return (
        ...
        >
          ...
          <g className="steam-group">
            <path
              ...
              className={cn(colorMap[color].steam, "animate-steam-1")}
              strokeWidth="0"
              fill="none"
            >
              <animate
            ...
            <path
              ...
              className={cn(colorMap[color].steam, "animate-steam-2")}
              strokeWidth="0"
              fill="none"
            >
              <animate
            ...
            <circle
              ...
              cy="12"
              r="8"
              className={cn(colorMap[color].steam, "animate-steam-fade")}
            >
              <animate
                attributeName="cy"
                values="12;8;12"
          ...
          <g className="bubbles-group">
            <circle
              ...
              cy="80"
              r="4"
              className={cn(colorMap[color].bubbles, "animate-bubble-1")}
            >
              <animate
                attributeName="cy"
                values="80;60;80"
            ...
            <circle
              ...
              cy="85"
              r="3"
              className={cn(colorMap[color].bubbles, "animate-bubble-2")}
            >
              <animate
                attributeName="cy"
                values="85;65;85"
            ...
            <circle
              ...
              cy="75"
              r="5"
              className={cn(colorMap[color].bubbles, "animate-bubble-3")}
            >
              <animate
                attributeName="cy"
                values="75;55;75"
