  ...
  const sendFeedback = useMutation({
    mutationFn: async ({
      ...
      const response = await fetch(
        `${API_ENDPOINTS.notifications.intelligent}/feedback`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                AI-powered notifications that learn your preferences and
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Learn your behavior patterns to deliver notifications at
                      optimal times
                    </p>
                  </div>
                  <Switch
                      ...
                      ([type, settings]) => {
                        const Icon =
                          notificationTypeIcons[
                            type as keyof typeof notificationTypeIcons
                          ];
                        const label =
                ...
                {recentNotifications.length > 0 ? (
                  <div className="space-y-2">
                    {recentNotifications.map((notif: NotificationScore) => {
                      const Icon =
                        notificationTypeIcons[
                          notif.type as keyof typeof notificationTypeIcons
                        ] || Bell;
                ...
                <div className="grid gap-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold">
                          {engagement.clickRate
                            ? `${Math.round(engagement.clickRate * 100)}%`
                            : "N/A"}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold">
                          {engagement.avgResponseTime
                            ? `${Math.round(engagement.avgResponseTime / 60)}m`
                            : "N/A"}
                        </p>
                      </div>
                  ...
                  <Card className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-muted-foreground">
                          Protected by Smart Filter
                        </p>
                        <p className="text-2xl font-bold">
                          {engagement.filteredCount || 0}
                        </p>
                      </div>
