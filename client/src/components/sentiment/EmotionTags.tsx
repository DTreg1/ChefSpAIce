...
const defaultEmotionConfig: { [key: string]: { Icon: LucideIcon; color: string } } = {
  happy: { Icon: Smile, color: 'text-yellow-600 dark:text-yellow-400 bg-yellow-50 dark:bg-yellow-900/20' },
  sad: { Icon: Frown, color: 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20' },
  angry: { Icon: Angry, color: 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20' },
  fearful: { Icon: AlertCircle, color: 'text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-900/20' },
  surprised: { Icon: Zap, color: 'text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-900/20' },
  disgusted: { Icon: HeartBroken, color: 'text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20' },
  excited: { Icon: Star, color: 'text-pink-600 dark:text-pink-400 bg-pink-50 dark:bg-pink-900/20' },
  frustrated: { Icon: CloudLightning, color: 'text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20' },
  satisfied: { Icon: Heart, color: 'text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-900/20' },
  disappointed: { Icon: Frown, color: 'text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/20' },
};
