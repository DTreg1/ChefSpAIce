...
export function ExcerptTester({
  ...
  const avgCTR =
    stats.reduce((sum, s) => sum + s.performance.ctr, 0) / stats.length;
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
              ...
              return (
                <div
                  ...
                  className={`p-4 border rounded-lg ${
                    ...
                    selectedVariant === stat.excerpt.id
                      ? "ring-2 ring-primary"
                      : ""
                  }`}
                  onClick={() =>
                    testMode === "manual" && setSelectedVariant(stat.excerpt.id)
                  }
                ...
                >
                  ...
                  <Progress value={stat.score} className="mt-2 h-2" />
                </div>
              );
            })}
          </div>
          ...
          {testMode === "auto" && bestPerformer && (
            <Alert>
              ...
              <AlertDescription>
                ...
                {(
                  ((bestPerformer.performance.ctr - avgCTR) / avgCTR) *
                  100
                ).toFixed(0)}
                % better than average. Consider making it the active excerpt.
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="flex justify-between">
            <Button variant="outline" data-testid="button-randomize">
            ...
            {onSelectWinner && (
              <Button
                ...
                disabled={
                  testMode === "manual" ? !selectedVariant : !bestPerformer
                }
