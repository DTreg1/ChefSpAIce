  ...
  return (
    <>
      ...
      <SidebarProvider style={style}>
        <div className="flex h-screen w-full bg-gradient-to-br from-lime-50/50 via-background to-green-50/30 dark:from-lime-950/20 dark:via-background dark:to-green-950/20">
          <AppSidebar />
