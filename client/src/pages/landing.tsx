...
export default function Landing() {
    ...
    if (endpoint) {
      ...
      try {
        ...
        if (configKey && !config.providers[configKey]) {
          console.error(
            `${provider} OAuth is not configured. Please add valid OAuth credentials.`,
          );
          alert(
            `${provider} authentication is not configured yet. Please set up OAuth credentials.`,
          );
          setIsLoading(false);
          return;
        }
  ...
  const features = [
    ...
    {
      icon: ShoppingCart,
      text: "Automated shopping lists",
      color: "text-pink-500",
    },
    {
      icon: Heart,
      text: "Personalized to your dietary needs",
      color: "text-red-500",
    },
  ];
          ...
          <div className="space-y-6">
            <Card className="border-2">
              <CardHeader>
                ...
                <CardDescription>
                  Join thousands who are saving time, money, and reducing food
                  waste
                </CardDescription>
              </CardHeader>
              ...
              <Tabs defaultValue="signup" className="w-full">
                ...
                <TabsContent value="signup" className="space-y-4">
                        ...
                        .map((provider) => (
                          ...
                          >
                            {isLoading && selectedProvider === provider.name ? (
                              ...
                              <provider.icon
                                className={`w-5 h-5 ${provider.iconColor}`}
                              />
                            )}
                  ...
                  <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>
                      Powered by Replit Auth - Enterprise-grade security
                    </span>
                  </div>
                  ...
                  <div className="bg-muted/50 rounded-lg p-3 mt-4">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-xs">
                        By signing up, you'll get personalized meal
                        recommendations, expiration alerts, and access to all
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="text-sm italic mb-2">
                  "ChefSpAIce has completely transformed how I manage my
                  kitchen. I've cut my food waste in half and discovered amazing
                  recipes I never would have tried!"
                </p>
