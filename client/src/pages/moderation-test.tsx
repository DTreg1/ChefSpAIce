...
const TEST_SAMPLES = [
  {
    label: "Safe Content",
    content:
      "This is a delicious chocolate cake recipe. Mix flour, sugar, cocoa powder, eggs, and milk. Bake at 350°F for 30 minutes.",
    type: "safe",
  },
  {
  ...
  },
  {
    ...
    content:
      "I'll come to your house and force you to eat this if you don't like it.",
    type: "threat",
  },
  {
    label: "Spam Content",
    content:
      "BUY NOW!!! BEST DEALS!!! CLICK HERE!!! LIMITED TIME OFFER!!! 50% OFF!!!",
    type: "spam",
  },
];
                ...
                <>
                  ...
                  <div className="mb-4 flex items-center gap-4">
                    ...
                    {result.severity && (
                      <Badge
                        variant={
                          getSeverityColor(result.severity) as
                            | "default"
                            | "outline"
                            | "destructive"
                            | "secondary"
                  ...
                  {/* Toxicity Scores */}
                  {result.toxicityScores &&
                    Object.keys(result.toxicityScores).length > 0 && (
                      <div>
                        <h3 className="font-semibold mb-2">Toxicity Scores:</h3>
                        <div className="space-y-2">
                          {Object.entries(result.toxicityScores).map(
