  ...
  const correctionMutation = useMutation({
    mutationFn: async (correction: Partial<OcrCorrection>) => {
      const response = await fetch(
        `${API_ENDPOINTS.ai.media.vision.ocr.extract}/correct`,
        {
          method: "POST",
    ...
    onSuccess: () => {
      toast({
        ...
        description:
          "Your correction has been saved to improve future OCR results",
      });
    },
  });
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">
          Extract text from images and PDFs using advanced optical character
          recognition
        </p>
      </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <OCRUploader onFileSelect={handleFileSelect} maxSizeInMB={20} />
