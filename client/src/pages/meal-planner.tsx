  ...
  return (
    <div className="h-full flex flex-col p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold" style={{ fontFamily: 'Georgia, serif' }}>Meal Planner</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="text-sm font-medium min-w-[150px] text-center" data-testid="text-month-year">
            {monthYear}
          </div>
          <Button
            variant="outline"
                ...
                <thead className="bg-muted/30 sticky top-0 z-10">
                  <tr>
                    ...
                    {weekDates.map((date, i) => {
                      const { dayName, monthDay, isToday } = formatDate(date);
                      return (
                        <th key={i} className="border-r border-border p-3 text-center min-w-[140px]">
                                ...
                                <Card className="h-full hover-elevate cursor-pointer">
                                  ...
                                  <CardContent className="p-3 pt-0">
                                    <div className="text-xs text-muted-foreground">
                                      {mealPlan.servings} {mealPlan.servings === 1 ? 'serving' : 'servings'}
                                    </div>
                                  </CardContent>
                                </Card>
                              </div>
                              ...
                              <button
                                ...
                                onClick={() => {
                                  toast({
                                    ...
                                    description: "Schedule recipes from the cookbook page. This feature will be enhanced soon!",
                                  });
                                }}
      ...
      <div className="flex items-center justify-between text-sm text-muted-foreground">
        <div data-testid="text-meals-planned">
          {mealPlans.length} {mealPlans.length === 1 ? 'meal' : 'meals'} planned this week
        </div>
        <Button
          variant="outline"
          onClick={() => {
