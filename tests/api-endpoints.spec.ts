 ...
 */
async function expectProtectedEndpoint(request: APIRequestContext, path: string) {
  const response = await request.get(path);
  expect(response.status(), `${path} should require auth (401) not be missing (404)`).toBe(401);
  
  const contentType = response.headers()['content-type'];
  expect(contentType, `${path} should return JSON error`).toContain('application/json');
}
...
async function expectEndpointExists(request: APIRequestContext, path: string) {
  ...
  expect([200, 401, 403], `${path} should return 200 or 401`).toContain(response.status());
}
...
async function expectAdminEndpoint(request: APIRequestContext, path: string) {
  const response = await request.get(path);
  expect(response.status(), `${path} should require auth/admin (401 or 403)`).toBe(401);
}

/**
 * Helper to verify a legacy endpoint works (doesn't 404)
 */
async function expectLegacyEndpointWorks(request: APIRequestContext, path: string) {
  const response = await request.get(path);
  expect(response.status(), `Legacy ${path} should work (401 auth required), not 404`).not.toBe(404);
  expect(response.status(), `Legacy ${path} should not error (500)`).not.toBe(500);
}

test.describe('API Endpoints - Health & Status', () => {
  test('GET /health returns healthy status with required fields', async ({ request }) => {
  ...
  test('GET /api/v1/health returns healthy status with environment', async ({ request }) => {
  ...
  test('GET /api/v1/info returns complete API information', async ({ request }) => {
  ...
  test('Legacy /api/health endpoint returns healthy status', async ({ request }) => {
...
test.describe('API Endpoints - User Domain - Inventory', () => {
  test('GET /api/v1/inventory endpoint exists and works', async ({ request }) => {
    await expectEndpointExists(request, '/api/v1/inventory');
  });

  test('GET /api/v1/inventory/usda/search endpoint exists', async ({ request }) => {
  ...
  test('GET /api/v1/food-items endpoint exists and works', async ({ request }) => {
...
test.describe('API Endpoints - User Domain - Meal Plans', () => {
  test('GET /api/v1/meal-plans endpoint exists and works', async ({ request }) => {
...
test.describe('API Endpoints - User Domain - Shopping List', () => {
  test('GET /api/v1/shopping-list requires authentication (401)', async ({ request }) => {
    await expectProtectedEndpoint(request, '/api/v1/shopping-list');
  });

  test('GET /api/v1/shopping-list/items requires authentication', async ({ request }) => {
...
test.describe('API Endpoints - User Domain - Appliances', () => {
  test('GET /api/v1/appliances endpoint exists and works', async ({ request }) => {
    await expectEndpointExists(request, '/api/v1/appliances');
  });

  test('GET /api/v1/appliances/library endpoint exists', async ({ request }) => {
    await expectEndpointExists(request, '/api/v1/appliances/library');
  });
});

test.describe('API Endpoints - User Domain - Nutrition', () => {
  test('GET /api/v1/nutrition endpoint exists and works', async ({ request }) => {
    await expectEndpointExists(request, '/api/v1/nutrition');
  });
});

test.describe('API Endpoints - User Domain - Utilities', () => {
  test('GET /api/v1/cooking-terms endpoint exists and works', async ({ request }) => {
...
test.describe('API Endpoints - Admin Domain', () => {
  ...
  test('GET /api/v1/admin requires authentication (401)', async ({ request }) => {
    await expectAdminEndpoint(request, '/api/v1/admin');
  });

  test('GET /api/v1/admin/users requires authentication (401)', async ({ request }) => {
    await expectAdminEndpoint(request, '/api/v1/admin/users');
  });

  test('GET /api/v1/admin/experiments requires authentication (401)', async ({ request }) => {
    await expectAdminEndpoint(request, '/api/v1/admin/experiments');
  });

  test('GET /api/v1/admin/cohorts requires authentication (401)', async ({ request }) => {
    await expectAdminEndpoint(request, '/api/v1/admin/cohorts');
  });

  test('GET /api/v1/admin/maintenance requires authentication (401)', async ({ request }) => {
    await expectAdminEndpoint(request, '/api/v1/admin/maintenance');
  });

  test('GET /api/v1/admin/pricing requires authentication (401)', async ({ request }) => {
    await expectAdminEndpoint(request, '/api/v1/admin/pricing');
  });

  test('GET /api/v1/admin/moderation requires authentication (401)', async ({ request }) => {
    await expectAdminEndpoint(request, '/api/v1/admin/moderation');
  });

  test('GET /api/v1/admin/ai-metrics requires authentication (401)', async ({ request }) => {
...
test.describe('API Endpoints - AI Domain', () => {
  test('GET /api/v1/ai/content endpoint exists and requires auth', async ({ request }) => {
  ...
  test('GET /api/v1/ai/analysis endpoint exists and requires auth', async ({ request }) => {
    const response = await request.get('/api/v1/ai/analysis');
    expect(response.status(), '/api/v1/ai/analysis should exist').not.toBe(404);
    expect(response.status()).not.toBe(500);
  });

  test('GET /api/v1/ai/media endpoint exists and requires auth', async ({ request }) => {
    const response = await request.get('/api/v1/ai/media');
    expect(response.status(), '/api/v1/ai/media should exist').not.toBe(404);
    expect(response.status()).not.toBe(500);
  });

  test('Legacy /api/v1/ai/generation path works (backward compatibility)', async ({ request }) => {
    const response = await request.get('/api/v1/ai/generation');
    expect(response.status(), 'Legacy ai/generation should not 404').not.toBe(404);
    expect(response.status()).not.toBe(500);
  });
});
...
test.describe('API Endpoints - Platform Domain - Notifications', () => {
  test('GET /api/v1/notifications endpoint exists and works', async ({ request }) => {
    await expectEndpointExists(request, '/api/v1/notifications');
  });

  test('GET /api/v1/notifications/tokens endpoint exists', async ({ request }) => {
    const response = await request.get('/api/v1/notifications/tokens');
    expect(response.status(), '/api/v1/notifications/tokens should exist').not.toBe(404);
    expect(response.status()).not.toBe(500);
  });
...
test.describe('API Endpoints - Platform Domain - Activities', () => {
  test('GET /api/v1/activities endpoint exists and works', async ({ request }) => {
...
test.describe('API Endpoints - Platform Domain - Feedback', () => {
  ...
  test('POST /api/v1/feedback requires authentication', async ({ request }) => {
    ...
    expect(response.status(), '/api/v1/feedback POST should exist').not.toBe(404);
    expect(response.status()).not.toBe(500);
  });
});
...
test.describe('API Endpoints - Specialized Services', () => {
  test('GET /api/v1/fraud-detection endpoint exists', async ({ request }) => {
    ...
    expect(response.status(), '/api/v1/fraud-detection should exist').not.toBe(404);
    expect(response.status()).not.toBe(500);
  });

  test('GET /api/v1/scheduling requires authentication', async ({ request }) => {
...
test.describe('API Endpoints - Backward Compatibility', () => {
  test('All legacy user endpoints work (not 404)', async ({ request }) => {
    ...
    for (const endpoint of legacyEndpoints) {
      ...
      expect(response.status(), `Legacy ${endpoint} should not 404`).not.toBe(404);
      expect(response.status(), `Legacy ${endpoint} should not 500`).not.toBe(500);
    }
  });
...
test.describe('API Endpoints - Error Handling', () => {
  test('Invalid JSON body returns 401 (unauthenticated) not 500', async ({ request }) => {
  ...
  test('API error responses for auth are JSON with error field', async ({ request }) => {
...
test.describe('API Endpoints - Authentication Flow', () => {
  ...
  test('GET /api/v1/auth/session responds appropriately', async ({ request }) => {
    const response = await request.get('/api/v1/auth/session');
    // Should exist and respond - not 404 or 500
    expect(response.status(), '/api/v1/auth/session should exist').not.toBe(404);
    expect(response.status(), '/api/v1/auth/session should not error').not.toBe(500);
  });

  test('Core user endpoints exist and respond correctly', async ({ request }) => {
    const endpoints = [
      '/api/v1/inventory',
      '/api/v1/recipes',
      '/api/v1/meal-plans',
    ...
    for (const endpoint of endpoints) {
      const response = await request.get(endpoint);
      expect(response.status(), `${endpoint} must exist (not 404)`).not.toBe(404);
      expect(response.status(), `${endpoint} must not error (500)`).not.toBe(500);
    }
  });
});
...
test.describe('API Endpoints - Critical Route Verification', () => {
  ...
  test('Strictly protected endpoints require authentication (401)', async ({ request }) => {
