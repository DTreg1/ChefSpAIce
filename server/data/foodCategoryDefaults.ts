  ...
  [
    ...
    },
    {
      ...
      defaults: {
        ...
        unit: "count",
        storageLocation: "Fridge",
        estimatedExpirationDays: 21,
      },
    },

    // Meat
    {
      pattern: /\bchicken\b/i,
      defaults: {
        quantity: "1",
        unit: "lb",
        storageLocation: "Fridge",
...
export function ensureRequiredFields(
  ...
  return {
    ...
    expirationDate:
      item.expirationDate ||
      calculateExpirationDate(defaults.estimatedExpirationDays),
