...
export const API_CONFIG = {
  ...
  LEGACY_PATHS: {
    ...
    "/api/shopping-list/generate-from-meal-plans":
      "/api/v1/shopping-list/generate-from-meal-plans",
  ...
  DEPRECATION_MESSAGE:
    "This endpoint is deprecated and will be removed after June 1, 2024. Please use the new RESTful API endpoints.",
