  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const circuitBreakerStatus = {
        ...
        lastFailureTime: chatStats.lastFailureTime
          ? new Date(chatStats.lastFailureTime)
          : undefined,
        nextAttemptTime:
          chatStats.state === "open" && chatStats.lastFailureTime
        ...
        services: {
          ...
          recipe: {
            ...
            lastFailureTime: recipeStats.lastFailureTime
              ? new Date(recipeStats.lastFailureTime)
              : undefined,
          },
        },
      };
 ...
 */
router.post(
  "/admin/ai-metrics/reset-circuit-breaker",
  isAuthenticated,
  adminOnly,
  async (req: Request, res: Response) => {
    try {
