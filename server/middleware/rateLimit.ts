  ...
  middleware() {
    return (req: Request, res: Response, next: NextFunction) => {
      ...
      res.setHeader(
        ...
        String(this.options.maxRequests - requestData.count),
      );
      res.setHeader(
        "X-RateLimit-Reset",
        new Date(requestData.resetTime).toISOString(),
...
export const rateLimiters = {
  ...
  usda: new RateLimiter({
    ...
    maxRequests: 1000,
    message:
      "USDA API rate limit exceeded. Please wait before making more nutrition queries.",
  }),
  ...
  barcode: new RateLimiter({
    ...
    maxRequests: 500,
    message:
      "Barcode lookup rate limit exceeded. Please wait before scanning more items.",
  }),
  ...
  openai: new RateLimiter({
    ...
    maxRequests: 100,
    message:
      "AI assistant rate limit exceeded. Please wait before making more requests.",
  }),
