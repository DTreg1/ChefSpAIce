...
import {
  activityLogger,
  ActivityActions,
} from "../services/activity-logger.service";
...
const routePatterns: RoutePattern[] = [
  ...
  {
    method: "POST",
    pattern: /^\/api\/food-items$/,
    action: ActivityActions.FOOD_ADDED,
    entity: "food_item",
  },
  {
    method: "PUT",
    pattern: /^\/api\/food-items\/[\w-]+$/,
    action: ActivityActions.FOOD_UPDATED,
    entity: "food_item",
  },
  {
    method: "PATCH",
  ...
  },
  {
    method: "DELETE",
    pattern: /^\/api\/food-items\/[\w-]+$/,
    action: ActivityActions.FOOD_DELETED,
    entity: "food_item",
  },
  {
    method: "POST",
    pattern: /^\/api\/food-items\/[\w-]+\/consume$/,
    action: ActivityActions.FOOD_CONSUMED,
    entity: "food_item",
  },
  ...
  {
    method: "POST",
    pattern: /^\/api\/recipes\/generate$/,
    action: ActivityActions.RECIPE_GENERATED,
    entity: "recipe",
  },
  {
    method: "POST",
    pattern: /^\/api\/recipes$/,
    action: ActivityActions.RECIPE_SAVED,
    entity: "recipe",
  },
  {
    method: "PUT",
    pattern: /^\/api\/recipes\/[\w-]+$/,
    action: ActivityActions.RECIPE_UPDATED,
    entity: "recipe",
  },
  {
    method: "PATCH",
  ...
  },
  {
    method: "DELETE",
    pattern: /^\/api\/recipes\/[\w-]+$/,
    action: ActivityActions.RECIPE_DELETED,
    entity: "recipe",
  },
  {
    method: "POST",
    pattern: /^\/api\/recipes\/[\w-]+\/rate$/,
    action: ActivityActions.RECIPE_RATED,
    entity: "recipe",
  },
  {
    method: "POST",
    pattern: /^\/api\/recipes\/[\w-]+\/favorite$/,
    action: ActivityActions.RECIPE_FAVORITED,
    entity: "recipe",
  },
  ...
  },
  {
    method: "DELETE",
    pattern: /^\/api\/chat$/,
    action: ActivityActions.CHAT_CLEARED,
    entity: "chat",
  },
  ...
  // Shopping list - Handle parameterized routes
  {
    ...
    action: ActivityActions.SHOPPING_ITEM_ADDED,
    entity: "shopping_list",
  },
  {
    method: "PUT",
    pattern: /^\/api\/shopping-list\/[\w-]+\/check$/,
    action: ActivityActions.SHOPPING_ITEM_CHECKED,
    entity: "shopping_list",
  },
  {
    method: "PUT",
    pattern: /^\/api\/shopping-list\/[\w-]+$/,
  ...
  },
  {
    method: "DELETE",
    pattern: /^\/api\/shopping-list$/,
    action: ActivityActions.SHOPPING_LIST_CLEARED,
    entity: "shopping_list",
  },
  ...
  {
    method: "POST",
    pattern: /^\/api\/meal-plans$/,
    action: ActivityActions.MEAL_PLANNED,
    entity: "meal_plan",
  },
  {
    method: "PUT",
    pattern: /^\/api\/meal-plans\/[\w-]+\/complete$/,
    action: ActivityActions.MEAL_COMPLETED,
    entity: "meal_plan",
  },
  {
    method: "PUT",
    pattern: /^\/api\/meal-plans\/[\w-]+\/skip$/,
    action: ActivityActions.MEAL_SKIPPED,
    entity: "meal_plan",
  },
  {
    method: "PUT",
    pattern: /^\/api\/meal-plans\/[\w-]+$/,
    action: ActivityActions.MEAL_UPDATED,
    entity: "meal_plan",
  },
  {
    method: "DELETE",
  ...
  {
    method: "PUT",
    pattern: /^\/api\/storage-locations\/[\w-]+$/,
  ...
  {
    method: "POST",
    pattern: /^\/api\/appliances$/,
    action: "appliance_added",
    entity: "appliance",
  },
  {
    method: "PUT",
    pattern: /^\/api\/appliances\/[\w-]+$/,
  ...
  // Feedback
  {
    ...
    action: ActivityActions.FEEDBACK_SUBMITTED,
    entity: "feedback",
  },
  ...
  // Notifications
  {
    ...
    action: ActivityActions.NOTIFICATION_SENT,
    entity: "notification",
  },
  {
    method: "PUT",
    pattern: /^\/api\/notifications\/[\w-]+\/delivered$/,
    action: ActivityActions.NOTIFICATION_DELIVERED,
    entity: "notification",
  },
  {
    method: "DELETE",
    pattern: /^\/api\/notifications\/[\w-]+$/,
    action: ActivityActions.NOTIFICATION_DISMISSED,
    entity: "notification",
  },
  ...
  {
    method: "PATCH",
    pattern: /^\/api\/admin\/users\/[\w-]+\/admin$/,
...
function getActivityTypeFromMethod(
  method: string,
):
  | "view"
  | "login"
...
export function activityLoggingMiddleware(
  ...
  res.on("finish", () => {
    try {
      ...
      if (!routeConfig) {
        ...
        if (req.method !== "GET") {
          ...
          activityLogger
            ...
            .catch((error) => {
              console.error(
                "[ActivityLoggingMiddleware] Error logging activity:",
                error,
              );
            });
        }
      ...
      // Log specific action
      const resourceId =
        extractEntityId(req.path, req.method) ||
        responseBody?.id ||
        req.params?.id ||
        null;
      ...
      if (
        ...
        activityLogger
          ...
          .catch((error) => {
            console.error(
              "[ActivityLoggingMiddleware] Error logging AI response:",
              error,
            );
          });
      }
